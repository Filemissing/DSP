...
public abstract class DSP_CharacterDisappearEffect : DSP_BaseEffect { }

public class DSP_CharacterDisappearFade : DSP_CharacterDisappearEffect
{
...
public class DSP_CharacterDisappearScale : DSP_CharacterDisappearEffect
{
    public override IEnumerator PlayEffect(float duration, AnimationCurve curve)
    {
        StartEffect();
