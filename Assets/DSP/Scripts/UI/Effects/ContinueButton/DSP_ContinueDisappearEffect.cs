...
public abstract class DSP_ContinueDisappearEffect : DSP_BaseEffect { }

public class DSP_ContinueDisappearFade : DSP_ContinueDisappearEffect
{
...
public class DSP_ContinueDisappearScale : DSP_ContinueDisappearEffect
{
    public override IEnumerator PlayEffect(float duration, AnimationCurve curve)
    {
        StartEffect();
